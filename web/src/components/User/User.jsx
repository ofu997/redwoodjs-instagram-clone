    ...
    <>
      ...
      <div id="user-info-container">
        <section id="user-page-profile-pic">
          <img src={props.user.profilePicUrl} alt={props.user.profilePicUrl} />
        </section>
        <section id="user-page-user-info">
          <div id="user-info-handle-editLink">
            <h4>{props.user.handle}</h4>
            {currentUser.localStoragePassword ===
              props.user.localStoragePassword && (
              <Link
          ...
          <p className="user-bio">
            <strong>{props.user.userImages.length}</strong>{' '}
            {props.user.userImages.length == 1 ? `memo` : `memos`}
          </p>
