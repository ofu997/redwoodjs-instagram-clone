...
const Header = () => {
  ...
  return (
    <>
      ...
      >
        <Navbar.Brand href="/">
          <h1 className="branding-font">Memofolio</h1>
        </Navbar.Brand>
        ...
        <Navbar.Collapse id="basic-navbar-nav" className="justify-content-end">
          <Nav className="justify-content-end" activeKey="/">
            ...
            <Nav.Item className="cntr-v">
              ...
              {user.profilePicUrl ? (
                <Nav.Link
                  href={routes.userPage({ handle: user.handle })}
      ...
      {loading && (
        <h2 className="branding-font cntr-h rw-text-center">Logging out</h2>
      )}
      {error && (
        <h2 className="branding-font cntr-h rw-text-center">{error}</h2>
      )}
